    ...
    <section id="sobre-mi" className="container py-5 mt-5">
      ...
      <div className="row g-5 align-items-center">
        ...
        <div className="col-lg-6">
          <div className="p-4 border-start border-primary border-4 bg-body-tertiary rounded-end shadow-sm">
            {/* AQUÍ ESTÁ EL ARREGLO DE LA TRADUCCIÓN */}
          ...
          <div className="d-flex flex-column gap-4">
            ...
            <div className="card border-0 shadow-sm">
              <div className="card-body p-4">
                ...
                {/* AQUÍ ESTÁ EL ARREGLO DE LA BANDERA ("GB") */}
                <h4 className="h5 fw-bold mb-0"><span className="text-primary me-2">EN</span> {t('lang_english')}</h4>
              </div>
            </div>
